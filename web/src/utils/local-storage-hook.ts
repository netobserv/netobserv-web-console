...
export const localStorageHealthOvnSummaryExpandedKey = 'network-health-ovn-summary-expanded';
export const localStorageHealthBgpSummaryExpandedKey = 'network-health-bgp-summary-expanded';
